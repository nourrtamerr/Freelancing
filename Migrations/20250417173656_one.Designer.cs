...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Freelancing.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CityId = 1,
                            ConcurrencyStamp = "ac6e8a57-4794-4137-ba62-26ce11475b36",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJIeOc2NawJLABISqmIHIzbbFVTcoYFSqdk5qFrPp4E+7hSZjZaVqRPEYdEVG4tNdA==",
                            PhoneNumberConfirmed = false,
                            RefreshToken = "",
                            RefreshTokenExpiryDate = new DateTime(2025, 4, 17, 19, 36, 54, 554, DateTimeKind.Local).AddTicks(549),
                            SecurityStamp = "f5bb7fc9-eb4c-4f54-bd60-1105fee1c8dd",
            ...
            modelBuilder.Entity("Freelancing.Models.FreelancerWithdrawals", b =>
                {
                    b.HasBaseType("Payment");
                    ...
                    b.ToTable("FreelancerWithdrawals", (string)null);
                });
            ...
            modelBuilder.Entity("Freelancing.Models.FreelancerWithdrawals", b =>
                {
                    ...
                    b.HasOne("Payment", null)
                        .WithOne()
                        .HasForeignKey("Freelancing.Models.FreelancerWithdrawals", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
