        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectType = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    minimumPrice = table.Column<int>(type: "int", nullable: true),
                    maximumprice = table.Column<int>(type: "int", nullable: true),
                    BidCurrentPrice = table.Column<int>(type: "int", nullable: true),
                    BiddingStartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BiddingEndDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
